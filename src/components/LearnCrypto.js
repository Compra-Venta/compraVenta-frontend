        ...
        return (
            <div>
                ...
                <Nav className='ml-auto col-md-7 justify-content-end' navbar style={{paddingRight:'0px',justifyItems:'right'}} >
                    <NavItem>
                        <NavLink style={{color:'black',fontSize:'1.4rem',paddingRight:'2vw'}} className='me' href="#cryptocurrency"><span color='violet' >CryptoCurrency</span></NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink style={{color:'black',fontSize:'1.4rem',paddingRight:'2vw'}}  href="#blockchain">BlockChain </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink style={{color:'black',fontSize:'1.4rem',paddingRight:'2vw'}}  href="#trading">Trading </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink style={{color:'black',fontSize:'1.4rem',paddingRight:'2vw'}}  href="#">CompraVenta </NavLink>
                    </NavItem>
                </Nav>
                </Navbar>
                </div>
