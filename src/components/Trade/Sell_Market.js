...
export class Sell_Market extends Component {
  ...
  /*dismissAlert = () =>{
    ...
    handleSubmit = async (event) => {
      ...
      await this.props.placeMarketOrder({email: '', base:state.coin_pair.slice(0,3), quote: state.coin_pair.slice(3), b_amount: state.amount, date: '2021-04-24', time: '23:48:15', side: 'SELL'})
