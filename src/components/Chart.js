...
import {sma, ema, SMA, EMA} from 'technicalindicators'
...
var sampledata = [{ time: '2018-10-19', open: 180.34, high: 180.99, low: 178.57, close: 179.85 },
...
var emaData = [];
		...
		.then( t =>{
			//  console.log(data);
			 smaData = this.calculateSMA(data);
			 emaData = this.calculateEMA(data);
			})
        .catch(error =>{
            // alert(error)
