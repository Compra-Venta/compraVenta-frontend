  ...
  return (
    <div>
      <Navbar light expand='md' /*style={{marginBottom:'0px',marginTop:'0px',borderWidth:'medium'}}*/ className='{border-bottom border-primary} me' >
        ...
        <NavbarBrand  href="/" className="mr-auto" ><div className='col-sm-2'><img src='/assets/images/HeadLogo.png'height='100vh' width='100vh' style={{display:'inline-block',float:'left',maxHeight:'100%',width:'7vw',height:'7vw'}} /> </div><div style={{width:'100%',textAlign:'center',justifyContent:'center',verticalAlign:'center',marginTop:'auto'}} className='col-sm-3'> <h1 id='top' style={{fontSize:'3.5vw',alignContent:'center'}}>Compra Venta</h1></div></NavbarBrand>
