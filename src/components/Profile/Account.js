        ...
        return (
            <div className='container-fluid'>
                <div className='row' style={{padding:'10px',fontSize:'1.2rem'}}>
                    ...
                    <div className='col-6' style={{display:'inline-flex'}}><div className='row'> <div className='col-md-6 col-12'> Rating: &nbsp;<div className='my-auto col-md-6 col-12'> 
                    <ReactStars count={account_details.rating} color="#ffd700" size={28} edit={false}/></div></div></div> </div>
                 </div>   
                 <div className='row' style={{padding:'10px',fontSize:'1.2rem'}}>
